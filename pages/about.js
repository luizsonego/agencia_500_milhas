            ...
            <div className="container mx-auto px-4">
              <div className="flex flex-wrap justify-center text-center mb-24">
                ...
                <div className="w-full lg:w-10/12 px-4">
                  <StyledTitle className="font-passion-one  md:text-8xl text-3xl leading-normal font-black">Sobre a 500 Milhas</StyledTitle>
                ...
                <div className="w-full lg:w-10/12 px-4">
                  <StyledTitle className="font-passion-one  md:text-8xl text-3xl leading-normal font-black">VISÃO</StyledTitle>
                ...
                <div className="w-full lg:w-10/12 px-4">
                  <StyledTitle className="font-passion-one  md:text-8xl text-3xl leading-normal font-black">MISSÃO</StyledTitle>
                ...
                <div className="w-full lg:w-10/12 px-4 my-10">
                  <StyledTitle className="font-passion-one  md:text-8xl text-3xl leading-normal font-black">VALORES</StyledTitle>
                  <ul className="text-left flex flex-wrap text-gray-600 list-disc">
                    <li className="w-1/4">Criatividade</li>
                    <li className="w-1/4">Sonhos</li>
                    <li className="w-1/4">Imaginação</li>
                    <li className="w-1/4">Integridade</li>
                    <li className="w-1/4">Honestidade</li>
                    <li className="w-1/4">Respeito</li>
                    <li className="w-1/4">Liderança</li>
                    <li className="w-1/4">Atitude Crítica</li>
                    <li className="w-1/4">Responsabilidade</li>
                    <li className="w-1/4">Paixão por tecnologia</li>
                    <li className="w-1/4">Paixão automotiva</li>
                  </ul>
                </div>
                <p className="text-lg leading-relaxed m-4 text-gray-600 text-justify">
              ...
              <StyledTitle className="text-center font-passion-one md:text-8xl text-7xl leading-normal font-black">VÁ MAIS LONGE COM 500 MILHAS</StyledTitle>
