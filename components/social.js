...
function Social() {
  return (
    <div className="social-link">
      <ul>
        <li className="link">
          <a className="text-gray-500 mylink" href="https://www.facebook.com/Agência-500-Milhas-102975658500673" target="_blank">
            <Icon size={24} icon="facebook" color="none" fill="currentColor" />
          </a>
            <a className="social-link-hover" href="https://www.facebook.com/Agência-500-Milhas-102975658500673" target="_blank">
              Facebook
            </a>
        </li>
        <li className="link">
